...
prompt = "for the following graph, please collect all the named entities into a list as the format of \"Entity\": [entity, entity, entity, ...]"

image_file_path = 'Dataset/English/'
image_file_list = os.listdir(image_file_path)

output_path = 'Result/output_ner_english.json'
